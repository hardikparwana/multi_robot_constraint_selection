...
robots.append( SingleIntegrator2D(np.array([0,y_offset - 1.5]), dt, ax, id = 0, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([0.0,y_offset - 0.8]), dt, ax, id = 1, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([-0.3,y_offset - 0.7]), dt, ax, id = 3, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([0.5,y_offset - 1.0]), dt, ax, id = 5, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([-1,y_offset - 3.0]), dt, ax, id = 1, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([1,y_offset - 3.0]), dt, ax, id = 2, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([-0.5,y_offset - 2.0]), dt, ax, id = 1, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([0.5,y_offset - 2.0]), dt, ax, id = 2, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([-0.7,y_offset - 2.7]), dt, ax, id = 1, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([0.7,y_offset - 2.7]), dt, ax, id = 2, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([-0.3,y_offset - 3.0]), dt, ax, id = 1, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
robots.append( SingleIntegrator2D(np.array([0.3,y_offset - 3.0]), dt, ax, id = 2, color='g',palpha=1.0, alpha=alpha_cbf, eigen_alpha = eigen_alpha, num_robots = num_robots, num_obstacles=num_obstacles, num_eigen_connectivity=num_eigen_connectivity, num_connectivity=num_connectivity ) )
